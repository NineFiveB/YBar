...
Liquid Glass bar that replaces the native macOS menu bar outright — real
`NSGlassEffectView` backdrops on macOS 26+ (clear for bar pills, frosted for
popups), a near-black palette, and soft corners.
