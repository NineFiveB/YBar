...
| **ysuite-liquid** | `examples/ysuite-liquid` | The ysuite-web “Liquid Glass on Metal” mock: full-bleed strip, 28pt capsule pills, right cluster CPU / Wi-Fi / Bluetooth / battery / clock. |
